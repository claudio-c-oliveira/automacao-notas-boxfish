...
- **`MODO_EXECUCAO = rascunho`**: escreve na pasta raiz **`PRODUCAO_BOX-FISH_A-CONFERIR`**, dentro do Drive pessoal da Michelle (`michelle.mimiaguia@gmail.com`) — mesmas subpastas `FINANCEIRO`/`FINANCEIRO S02`, mesmo padrão de nomenclatura da estrutura oficial. Michelle confere o resultado ali antes de copiar manualmente pro Drive oficial.
